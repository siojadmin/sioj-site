...
export const foundationalDocuments: FoundationalDocument[] = [
  ...
  {
    filename: "SIOJ_NTA_2026-08-01_STATIC_CUSTODY_BILINGUAL-Manifesto.pdf",
    href: `${base}/SIOJ_NTA_2026-08-01_STATIC_CUSTODY_BILINGUAL-Manifesto.pdf`,
    titlePt: "Nota Técnica de Custódia Estática e Redundância Auditável",
    titleEn: "Technical Note on Static Custody and Auditable Redundancy",
    language: "pt",
    format: "PDF",
  },
  {
    filename: "SIOJ_MANIFESTO_HASH_APLICADOR_v1.7T-R_BILINGUE_2026-01-05_UTC-Manifesto.pdf",
    href: `${base}/SIOJ_MANIFESTO_HASH_APLICADOR_v1.7T-R_BILINGUE_2026-01-05_UTC-Manifesto.pdf`,
    titlePt: "Manifesto de Consolidação Hash Aplicador v1.7T-R",
    titleEn: "Hash Applicator Consolidation Manifest v1.7T-R",
    language: "pt",
    format: "PDF",
  },
  {
    filename: "SIOJ_RTE-ICP-2026_BILINGUE_2026-01-05_UTC_ASSINADO_ICP-pdf-Manifesto.pdf",
    href: `${base}/SIOJ_RTE-ICP-2026_BILINGUE_2026-01-05_UTC_ASSINADO_ICP-pdf-Manifesto.pdf`,
    titlePt: "RTE-ICP/SIOJ-2026 - Relatório Técnico de Encerramento",
    titleEn: "RTE-ICP/SIOJ-2026 - Technical Closing Report",
    language: "pt",
    format: "PDF",
  },
  {
  ...
  {
    filename: "SIOJ_NTA_2026-08-01_STATIC_CUSTODY_BILINGUAL-Manifesto.pdf",
    href: `${base}/en/SIOJ_NTA_2026-08-01_STATIC_CUSTODY_BILINGUAL-Manifesto.pdf`,
    titlePt: "Nota Técnica de Custódia Estática (cópia na coleção inglesa)",
    titleEn: "Technical Note on Static Custody and Auditable Redundancy",
    language: "en",
    format: "PDF",
  },
